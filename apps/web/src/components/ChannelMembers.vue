...
/* Custom scrollbar */
.members__scroll :deep(.q-scrollarea__container) {
  scrollbar-width: thin;
  scrollbar-color: rgba(148, 163, 184, 0.3) transparent;
}

.members__scroll :deep(.q-scrollarea__container)::-webkit-scrollbar {
  width: 6px;
}

.members__scroll :deep(.q-scrollarea__container)::-webkit-scrollbar-track {
  background: transparent;
}

.members__scroll :deep(.q-scrollarea__container)::-webkit-scrollbar-thumb {
  background: rgba(148, 163, 184, 0.3);
  border-radius: 3px;
}

.members__scroll :deep(.q-scrollarea__container)::-webkit-scrollbar-thumb:hover {
